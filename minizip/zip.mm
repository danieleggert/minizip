...
static linkedlist_datablock_internal* allocate_new_datablock()
{
    ...
    ldi = (linkedlist_datablock_internal*) malloc(sizeof(linkedlist_datablock_internal));
    if (ldi!=NULL)
    {
...
#    endif
    ...
    zi->ci.central_header = (char*) malloc((uInt)zi->ci.size_centralheader + zi->ci.size_centralExtraFree);
...
extern int ZEXPORT zipRemoveExtraInfoBlock (char* pData, int* dataLen, short sHeader)
{
  ...
  pNewHeader = (char*) malloc(*dataLen);
  pTmp = pNewHeader;
